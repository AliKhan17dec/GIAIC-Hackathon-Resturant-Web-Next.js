...
const Hero4 = () => {
  ...
  <div className="md:w-1/2 grid grid-cols-2 gap-4">
    {/* Large Top Image */}
    <img
      src="/whychooseus/unsplash_lP5MCM6nZ5A.png"
      alt="Tacos"
      className="col-span-2 row-span-2 rounded-md w-full h-[294px] object-cover"
    />
    {/* Smaller Images */}
    <img
      src="/whychooseus/unsplash_dphM2U1xq0U (1).png"
      alt="Burger"
      className="rounded-md w-full h-[140px] object-cover"
    />
    <img
      src="/whychooseus/unsplash_CLMpC9UhyTo (2).png"
      alt="Chicken Nuggets"
      className="rounded-md w-full h-[140px] object-cover"
    />
    <img
      src="/whychooseus/unsplash_-GFCYhoRe48.png"
      alt="Cheeseburger"
      className="rounded-md w-full h-[140px] object-cover"
    />
    <img
      src="/whychooseus/unsplash_mmnKI8kMxpc.png"
      alt="Salad"
      className="rounded-md w-full h-[140px] object-cover"
    />
    {/* Full-width Image in the Bottom Row */}
    <img
      src="/whychooseus/unsplash_tzl1UCXg5Es (1).png"
      alt="Bottom Image"
  ...
  <div className="md:w-1/2 mt-8 md:mt-0 md:pl-10">
    <h2 className="text-lg text-[#FF9F0D] font-medium">Why Choose us</h2>
    ...
    <div className="mt-8 flex space-x-8">
      ...
      <div className="flex flex-col items-center">
        <div className="bg-[#FF9F0D] p-4 rounded-md text-white w-[82px] h-[80px] flex justify-center items-center">
    ...
    <div className="mt-8 bg-white text-black py-4 px-6 rounded-lg flex items-center space-x-4">
      <span className="text-4xl font-bold text-[#FF9F0D]">30+</span>
      <div>
